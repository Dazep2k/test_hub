...
A3=USART_RX_BUF[2];
	...
	A4=USART_RX_BUF[3];
		GUI_ShowChar(5,5,A1,16,1);
	GUI_ShowChar(15,5,A2,16,1);
	GUI_ShowChar(25,5,A3,16,1);
GUI_ShowChar(35,5,A4,16,1);
	//		
	//	}
		USART_RX_STA=0;		
	delay_ms(2500);
